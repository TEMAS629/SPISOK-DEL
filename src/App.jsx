...
export default function App() {
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8"><Popover
        as="header"
        className={({ open }) =>
          classNames(
...
{/* main */}
  ...
  <input class = 'call' type="date" value="2017-06-01" />

  <div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="flex h-full flex-col">
  <fieldset>
...
{/* footer */}
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">{/* Content goes here */}</div>
